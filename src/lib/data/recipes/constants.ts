...
const ProcessingRecipes: MaterialRecipe[] = [
  ...
  },
  {
    ...
    outputs: [{ material: 'radiation shielding', amount: 2 }],
    type: 'processing',
    level: 2,
  },
  {
    ...
    inputs: [
      { material: 'water', amount: 1000 },
      { material: 'sulfur', amount: 1 },
      { material: 'oxygen', amount: 4 },
    ],
  ...
  },
  {
    ...
    outputs: [{ material: 'lithium-ion batteries', amount: 100 }],
    type: 'processing',
    level: 2,
  },
  {
  ...
  },
  {
    ...
    outputs: [{ material: 'servo motors', amount: 100 }],
    type: 'processing',
    level: 1,
  },
  {
    key: 'solar panel',
    inputs: [
      { material: 'silicon', amount: 40 },
      { material: 'copper', amount: 10 },
      { material: 'aluminum', amount: 10 },
    ],
  ...
  },
  {
    ...
    outputs: [{ material: 'precision bearings', amount: 8 }],
    type: 'processing',
    level: 1,
  },
  {
    ...
    inputs: [{ material: 'carbon', amount: 100 }],
    outputs: [{ material: 'carbon nanotubes', amount: 100 }],
    type: 'processing',
    level: 4,
  },
  {
    key: 'water recycling system',
    inputs: [
      { material: 'iron', amount: 100 },
      { material: 'carbon', amount: 10 },
      { material: 'water', amount: 1000 },
    ],
    outputs: [{ material: 'water recycling system', amount: 1 }],
    type: 'processing',
    level: 4,
  },
  {
    ...
    outputs: [{ material: 'thermal insulation', amount: 5 }],
    type: 'processing',
    level: 4,
  },
];
...
export const ManufacturingRecipes: MaterialRecipe[] = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { material: 'oxygen and co2 regulators', amount: 80 },
    ],
  ...
  },
  {
    ...
    inputs: [
      { material: 'lithium-ion batteries', amount: 5000 },
  ...
  {
    key: 'diamondium drill',
    inputs: [
      { material: 'diamond', amount: 16 },
      { material: 'servo motors', amount: 16 },
      { material: 'alloyed metal', amount: 1 },
    ],
    outputs: [{ material: 'diamondium drill', amount: 16 }],
    type: 'manufacturing',
    level: 3,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { material: 'oxygen and co2 regulators', amount: 320 },
